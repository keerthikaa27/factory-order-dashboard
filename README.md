...
I’ve deployed both the frontend and backend. The app supports multi-user authentication with JWT and roles (admin/user). For your convenience, I’ve created a demo account you can use to log in:
...
* Frontend: [http://localhost:5173], [https://factorydashboard.netlify.app]
* Backend API: [http://localhost:8000], [https://factory-order-dashboard.onrender.com/docs]
